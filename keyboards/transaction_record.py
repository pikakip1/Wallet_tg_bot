...
def make_menu_keyboard() -> ReplyKeyboardMarkup:
    ...
    keyboard = [
        [
            KeyboardButton(text=chose_menu[0]),
            KeyboardButton(text=chose_menu[1]),
            KeyboardButton(text=chose_menu[2]),
        ],
        [KeyboardButton(text=cancel_button)],
        [KeyboardButton(text=chose_menu[3]), KeyboardButton(text=chose_menu[-1])],
    ]
...
def get_menu_statistic_inline_keyboard() -> InlineKeyboardMarkup:
    ...
    for category_statistic in categories_statistics:
        builder.add(InlineKeyboardButton(text=category_statistic, callback_data=f"statistic_{category_statistic}"))
